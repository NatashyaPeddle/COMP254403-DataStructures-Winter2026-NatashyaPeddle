 ...
 */
public class CircularlyLinkedListEXAMPLE<E> {
  //---------------- nested Node class ----------------
  /**
  ...
  public CircularlyLinkedListEXAMPLE() { }             // constructs an initially empty list
...
//main method
  public static void main(String[] args)
  {
	  ...
	  //(LAX, MSP, ATL, BOS)
	  CircularlyLinkedListEXAMPLE<String> circularList = new CircularlyLinkedListEXAMPLE<String>();
